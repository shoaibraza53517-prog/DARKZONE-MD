...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "MRRAZAMD",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "RAZA",           // Owner's name
    DEV: process.env.DEV || "923488553517",                     // Developer's contact number
    DEVELOPER_NUMBER: '923488553517@s.whatsapp.net',            // Developer's WhatsApp ID
